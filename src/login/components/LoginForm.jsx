...
import { Button, FormControl, Grid, Select, MenuItem, Alert, Dialog, DialogTitle } from "@mui/material";
...
export const LoginForm = () => {
  ...
  <>
      ...
      <Grid container spacing={2}>
        ...
        {userType === 'estudiante' && (
          <Grid container justifyContent="flex-end" item xs={12}>
              <Button variant="text" color="primary" onClick={handleForgotPasswordOpen}>
    ...
    <Dialog open={forgotPasswordOpen} onClose={handleForgotPasswordClose}>
        <RecuperarContrasenaForm onClose={handleForgotPasswordClose} />
    </Dialog>
  </>
  );
};
